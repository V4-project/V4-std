...
TEST_CASE("LED SYS: LED_ON (active-low LED)") {
  ...
  int32_t result = invoke_sys_handler(V4SYS_LED_ON, V4DEV_LED, V4ROLE_USER, 1);
...
TEST_CASE("LED SYS: LED_OFF (active-low LED)") {
  ...
  int32_t result = invoke_sys_handler(V4SYS_LED_OFF, V4DEV_LED, V4ROLE_USER, 1);
...
TEST_CASE("LED SYS: LED_GET") {
  ...
  int32_t result = invoke_sys_handler(V4SYS_LED_GET, V4DEV_LED, V4ROLE_USER, 0);
...
TEST_CASE("LED SYS: LED_GET with active-low") {
  ...
  int32_t result = invoke_sys_handler(V4SYS_LED_GET, V4DEV_LED, V4ROLE_USER, 1);
