...
void unregister_sys_handler(uint16_t sys_id) { handler_registry.erase(sys_id); }
...
void clear_sys_handlers() { handler_registry.clear(); }

size_t get_sys_handler_count() { return handler_registry.size(); }
